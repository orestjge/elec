...
### ★ Google Play クローズドテストへの参加のお願い（おすすめ）

現在、Google Play での公開に向けてクローズドテストを実施しています。**Play ストアから普通にインストール・自動更新できる**ので、こちらの方法がおすすめです。テスターとしてご協力いただけると助かります。以下の手順で参加できます。
...
Play ストアを使わない場合は、APK を直接インストールすることもできます。
